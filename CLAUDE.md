...
**YOU ARE IN: `cogito/polecats/guzzle/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/cogito/` (rig root) or other directories
...
**Your mail address:** `cogito/polecats/guzzle`
**Your rig:** cogito
**Your Witness:** `cogito/witness`
...
| Ask Witness for help | `gt mail send cogito/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`cogito/witness`) when:
...
```bash
gt mail send cogito/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
